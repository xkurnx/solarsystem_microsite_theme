	...
	***************************/
	...
	$.fn.jqTransInputText = function(){
		return this.each(function(){
			...
			if($input.attr('size')){
				...
				$input.css('width',inputSize-8);
			}
			
			$input.addClass("jqTransformInput").wrap('<div class="jqTransformInputWrapper"><div class="jqTransformInputInner"><div></div></div></div>');
			var $wrapper = $input.parent().parent().parent();
			/*$wrapper.css("width", inputSize+8);*/
			$input
			...
			$.browser.safari && $input.css('width',$wrapper.width()+14);
	...
	$.fn.jqTransSelect = function(){
		return this.each(function(index){
			...
			$wrapper
				.focus(function(){$wrapper.addClass("jqTransformSelectWrapper_hover");})
				.blur(function(){$wrapper.removeClass("jqTransformSelectWrapper_hover");})
				.hover(function(){$wrapper.addClass("jqTransformSelectWrapper_hover");},function(){$wrapper.removeClass("jqTransformSelectWrapper_hover");})
